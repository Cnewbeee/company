<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="部门联系电话" prop="deptPhone">
        <el-input
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="部门经理" align="center" prop="deptManager" />
      <el-table-column label="部门联系电话" align="center" prop="deptPhone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="部门经理" prop="deptManager">
          <el-input v-model="form.deptManager" placeholder="请输入部门经理" />
        </el-form-item>
        <el-form-item label="部门联系电话" prop="deptPhone">
          <el-input v-model="form.deptPhone" placeholder="请输入部门联系电话" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除部门信息编号为"' + deptIds + '"的数据项？').then(function() {
